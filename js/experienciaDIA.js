$(document).ready(function() {
	...
	$("form#formExpD").validetta({
			...
			bubblePosition: 'bottom',
  			...
  			onValid : function(e){
	  			e.preventDefault();
	  			var obj=$("form#formExpD").serializeToJSON({
			                ...
			                if(Jresp["estado"]=="1"){
			                    $.alert({
			                        ...
			                        onDestroy: function () {
		    							...
		    							$('#formExpD').find('input, textarea, button, select').attr('disabled','disabled');
		    							$('#formExpD').find('.fa-plus').hide();
		    							$('#formExpD').find('.fa-minus').hide();
	    							}
			                    });
			                }  
			            },
